    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <div>
                ...
                <form action="/addProject" method="post" id="account" class="layui-form">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">负责人</label>
                            <label class="layui-form-label">${(accounts.name)}</label>
                            <div class="layui-input-inline"> <input type="number" value="${(accounts.id)}" name="account_id" style="display:none"> </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">任务</label>
                        <div class="layui-input-inline">
                            <input type="text" name="project" lay-verify="required" placeholder="请输入任务主题" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">内容</label>
                        <div class="layui-input-block">
                            <textarea name="context" placeholder="请输入任务内容" class="layui-textarea"></textarea>
                        </div>
                    </div>
