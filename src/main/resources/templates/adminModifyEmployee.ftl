            ...
            <div class="layui-form">
                <form name="Employee_modify_Form" method="post">
                    <div class="layui-form-item">
                        ...
                        <label class="layui-form-label">${empl.name}</label>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">业务</label>
                        <div class="layui-input-inline">
                            <input type="text" value="${empl.work}" name="work" lay-verify="required" placeholder="请输入职位" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">职位</label>
                        <div class="layui-input-inline">
                            <input type="text" value="${empl.position}" name="position" lay-verify="required" placeholder="请输入职位" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">地区</label>
                        <div class="layui-input-inline">
                            <input type="text" value="${empl.area}" name="area" lay-verify="required" placeholder="请输入地区" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <label class="layui-form-label">&emsp;</label>
                    <input class="layui-btn" type="button" name="modify" value="修改" id="${empl.id}">
...
<script type="text/javascript">
    $(function(){
        $("input[name='modify']").click(function(){if(confirm("是否确认修改？")){
            $("form[name='Employee_modify_Form']").attr("action","/modifyEmployee?id="+$(this).attr("id"));
